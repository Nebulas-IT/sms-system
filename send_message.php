...
if ($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['submit']) && $_POST['date_time'] == '') {
//    echo "<pre>";
//    echo print_r($_POST);
//    echo "</pre>";
    $mobiles = $_POST['mobile'];
        ...
        <div class="col-lg-9">
            ...
            <div class="row mt">
                <div class="form-panel">
                    <form class="form-horizontal style-form" method="POST" action="" id="multiple_select_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="framework" id="framework" class="form-control selectpicker" data-live-search="true" multiple>
                                    ...
                                    $getCotacts = $ci->getAllContact();

                                    if ($getCotacts) {
                                        $i = 0;
                                        while ($result = $getCotacts->fetch_assoc()) {
                                            $i++;
                                            ?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="submit" name="submit" value="Send Message"
                                       style="align-content: center; float:inherit;margin-left: 10px; margin-top:20px;font-size: 20px;">
                            </div>
                        </div>
                    </form>
                </div>
